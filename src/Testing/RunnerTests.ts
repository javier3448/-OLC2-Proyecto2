...
console.log(potencia(30,5)); //24300000
    ...
    //Ordenamiento.ts
    //We kinda PASS 
    //our Array behaviour with outofbounds and index is not integer is pretty broken
  ...
  menu();
    ...
    //TODO: we cant do avl.ts yet because we dont havent templated strings :(
    {
    let testString = `
type AVLNode = {
    left: AVLNode,
