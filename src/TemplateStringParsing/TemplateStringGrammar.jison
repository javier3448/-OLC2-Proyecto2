...
//BUG: possiblemente. No se como se recupera si no viene ninguna expresion porque usamos EOF para recuperarnos
//BUG: no reporta errores sintacticos en la runtimeInterface, solo en la consola
